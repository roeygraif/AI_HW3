...
ID = 315111401  # TODO: change it to your personal ID
...
def l2_dist(x1: np.array, x2: np.array):
    ...
    # Taking the square root to get the actual L2 distance
    dists = np.sqrt(dists)
    # ========================
...
def load_data_set(clf_type: str)-> Tuple[List[str], pd.DataFrame, pd.DataFrame]:
    """
